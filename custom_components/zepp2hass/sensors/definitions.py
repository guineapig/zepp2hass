...
_DIAGNOSTIC_SENSORS: Final[list[SensorDef]] = [
    ...
    SensorDef(
        json_path="debug.sensor_status",
        key="watch_debug_sensor_status",
        name="Watch Debug Sensor Status",
        icon="mdi:heart-pulse",
        category=EntityCategory.DIAGNOSTIC,
    ),
    SensorDef(
        json_path="debug.last_sensor_success_at",
        key="watch_debug_last_sensor_success",
        name="Watch Debug Last Sensor Success",
        icon="mdi:clock-check-outline",
        category=EntityCategory.DIAGNOSTIC,
    ),
    SensorDef(
        json_path="debug.last_sensor_error_class",
        key="watch_debug_last_sensor_error",
        name="Watch Debug Last Sensor Error",
        icon="mdi:alert-circle-outline",
        category=EntityCategory.DIAGNOSTIC,
    ),
    SensorDef(
        json_path="debug.bridge_state",
        key="watch_debug_bridge_state",
        name="Watch Debug Bridge State",
        icon="mdi:bridge",
        category=EntityCategory.DIAGNOSTIC,
        attributes_map={"error_class": "debug.bridge_error_class"},
    ),
    SensorDef(
        json_path="debug.service_state",
        key="watch_debug_service_state",
        name="Watch Debug Service State",
        icon="mdi:cog-sync-outline",
        category=EntityCategory.DIAGNOSTIC,
        attributes_map={"start_count": "debug.service_start_count"},
    ),
    SensorDef(
        json_path="debug.current_view",
        key="watch_debug_current_view",
        name="Watch Debug Current View",
        icon="mdi:view-dashboard-outline",
        category=EntityCategory.DIAGNOSTIC,
    ),
    SensorDef(
        json_path="debug.sync_interval_minutes",
        key="watch_debug_sync_interval",
        name="Watch Debug Sync Interval",
        unit=UnitOfTime.MINUTES,
        icon="mdi:timer-sync-outline",
        category=EntityCategory.DIAGNOSTIC,
    ),
    SensorDef(
        json_path="debug.settings_source",
        key="watch_debug_settings_source",
        name="Watch Debug Settings Source",
        icon="mdi:home-assistant",
        category=EntityCategory.DIAGNOSTIC,
        attributes_map={
            "debug_mode": "debug.debug_mode",
            "sensor_sync_enabled": "debug.sensor_sync_enabled",
            "sensor_allowlist_count": "debug.sensor_allowlist_count",
        },
    ),
    SensorDef(
        json_path="debug.pending_request_count",
        key="watch_debug_pending_requests",
        name="Watch Debug Pending Requests",
        icon="mdi:inbox-arrow-down-outline",
        category=EntityCategory.DIAGNOSTIC,
        attributes_map={
            "ack_retry_queue_size": "debug.ack_retry_queue_size",
            "tracker_queue_size": "debug.tracker_queue_size",
        },
    ),
    SensorDef(
        json_path="debug.last_command_status",
        key="watch_debug_last_command",
        name="Watch Debug Last Command",
        icon="mdi:message-processing-outline",
        category=EntityCategory.DIAGNOSTIC,
        attributes_map={
            "request_type": "debug.last_command_type",
            "result_class": "debug.last_command_result_class",
        },
    ),
]
